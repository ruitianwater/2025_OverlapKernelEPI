...
% single-shot, 2-slice, b=0,1000s/mm2
...
Ny=150; % Define pixel size along phase encoding
Nx=150; % Define pixel size along readout
b2DNav = 0; % 0: no 2D navigator. 1: 2D navigator
...
Nshot = 1; % Number of readout segments, should be odd for now
...
factor_sp = 6;
scale_sp = 1.5;
gy_spoiler = mr.makeTrapezoid('y',lims_prephase,'Area',(-1)*factor_sp*Ny_post*deltak*nPI,'duration',scale_sp*readoutTime/Nx*Ny_post*nPI*factor_sp);
gz_spoiler = mr.makeTrapezoid('z',lims_prephase,'Area',factor_sp*Ny_post*deltak*nPI,'duration',scale_sp*readoutTime/Nx*Ny_post*nPI*factor_sp);
